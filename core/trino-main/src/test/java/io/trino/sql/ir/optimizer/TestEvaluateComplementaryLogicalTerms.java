...
import io.trino.sql.ir.optimizer.rule.EvaluateComplementaryLogicalTerms;
...
class TestEvaluateComplementaryLogicalTerms
{
    ...
    {
        return new EvaluateComplementaryLogicalTerms(PLANNER_CONTEXT).apply(expression, testSession(), ImmutableMap.of());
    }
}
