...
public interface Metadata
{
     ...
     */
    InsertTableHandle beginRefreshMaterializedView(Session session, TableHandle tableHandle, List<TableHandle> sourceTableHandles, QueryTransformationType transformationType);
