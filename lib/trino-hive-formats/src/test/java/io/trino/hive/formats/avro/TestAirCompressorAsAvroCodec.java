...
{
    @DataProvider(name = "kinds")
    public static Object[][] compressionKinds()
    {
        return Arrays.stream(AvroCompressionKind.values()).map(k -> new AvroCompressionKind[] {k}).toArray(Object[][]::new);
    }
